...
when call printTicket()
then print the ticket with no discount
```
- task 2
```text
...
when call printTicket()
then print the ticket with discount rate is 3%
```
- task 4
```text
given one kind of item with total price more than 1000 and state is UT
